...
export const INITIAL_CAREGIVERS: CaregiverProfile[] = [
  {
    ...
    skills: ['GDA Clinical Assistant', 'IV & Vitals Vigilance', 'Post-Op Mobility'],
  ...
  },
  {
    ...
    skills: ['Night Vigil Specialist', 'GDA Clinical Assistant', 'IV & Vitals Vigilance'],
    aadhaarVerified: true,
    policeVerificationPassed: true,
    hospitalPassApproved: true,
    rating: 4.95,
  ...
  },
  {
    ...
    skills: ['Post-Op Mobility', 'Hindi & Regional Fluent'],
    aadhaarVerified: true,
    policeVerificationPassed: true,
    hospitalPassApproved: true,
    rating: 4.85,
  ...
  },
  {
    ...
    experienceYears: 5,
    qualification: 'GDA Certified (General Duty Assistant)',
    skills: ['Dementia & Elder Companion', 'Hindi & Regional Fluent', 'Post-Op Mobility'],
    aadhaarVerified: true,
    policeVerificationPassed: true,
    hospitalPassApproved: true,
    rating: 4.92,
  ...
  },
  {
    ...
    experienceYears: 7,
    qualification: 'Senior Patient Attendant',
    skills: ['Night Vigil Specialist', 'IV & Vitals Vigilance'],
    aadhaarVerified: true,
    policeVerificationPassed: true,
    hospitalPassApproved: true,
    rating: 4.88,
